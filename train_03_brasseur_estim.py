    ...
    for mode_int in i_mode_ints:
        ...
        if i_plot > 0:
            if i_plot_type == 0:
                ...
                plot_mod_vs_obs(obs_gust, gust_max, gust_est_max_unscaled)
            else:
            ...
            if i_plot == 1:
                ...
                if i_plot_type == 0:
                    plot_name = CN.plot_path + 'tuning_braes_'+str(mode)+'.png'
                elif i_plot_type == 1:
                    plot_name = CN.plot_path + 'plot1_tuning_braes_'+str(mode)+'.png'
                print(plot_name)
