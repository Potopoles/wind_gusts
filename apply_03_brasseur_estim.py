...
gust_est_max_original = data['gust_est_max_unscaled']
...
gust_est_max_original = gust_est_max_original[~errormask]
...
for mode in params.keys():
    ...
    plot_error(obs_gust_flat, model_mean, obs_mean_flat, gust_max, gust_est_max_original)
